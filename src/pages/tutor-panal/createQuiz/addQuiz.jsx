                    ...
                    <Grid container spacing={2} >
                        ...
                        <Grid item xs={12} >
                            <Grid container spacing={2} >
                                ...
                                <Grid item xs={12} md={3} lg={2} >
                                    <div style={{ backgroundColor: '#E1E1E1', height: '11rem', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '7px' }} >
                        ...
                        <Grid item xs={12}  >
                            <div className='tutor-create-quiz-record-audio-btn' >
                                <button>
